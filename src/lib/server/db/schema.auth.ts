...
import { PrefThemeMode } from "../../types/schema";
...
export const user = sqliteTable("user", {
	...
	prefThemeMode: text("pref_theme_mode", {
		enum: [PrefThemeMode.System, PrefThemeMode.Light, PrefThemeMode.Dark]
	})
		.default(PrefThemeMode.System)
		.notNull(),
